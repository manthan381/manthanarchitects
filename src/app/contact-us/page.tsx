        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="space-y-8">
            <div className="bg-gray-50 p-8 rounded-3xl border border-gray-100 shadow-sm relative overflow-hidden group">
              ...
              <div className="relative z-10">
                <div className="flex items-center gap-3 sm:gap-4 mb-6">
                  <div className="bg-gray-900 p-3 rounded-2xl text-white flex-shrink-0">
                    <MapPin size={24} className="scale-90 sm:scale-100" />
                  </div>
                  <h3 className="text-xl sm:text-2xl font-bold leading-tight">our office address</h3>
                </div>
                <p className="text-gray-700 text-base sm:text-lg leading-relaxed lowercase break-words">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="bg-white p-4 sm:p-6 rounded-2xl border border-gray-100 shadow-sm flex items-center gap-3 sm:gap-4 hover:border-primary/30 transition-colors">
                <div className="bg-green-50 p-3 rounded-xl text-green-600 flex-shrink-0"><MessageCircle size={20} /></div>
                <div className="min-w-0">
                  <p className="text-xs text-gray-400 font-bold lowercase">whatsapp</p>
                  <p className="font-bold text-gray-800 text-sm sm:text-base break-words">+91-9958097927</p>
                </div>
              </div>
              <div className="bg-white p-4 sm:p-6 rounded-2xl border border-gray-100 shadow-sm flex items-center gap-3 sm:gap-4 hover:border-primary/30 transition-colors">
                <div className="bg-blue-50 p-3 rounded-xl text-blue-600 flex-shrink-0"><Phone size={20} /></div>
                <div className="min-w-0">
                  <p className="text-xs text-gray-400 font-bold lowercase">call us</p>
                  <p className="font-bold text-gray-800 text-sm sm:text-base break-words">+91-9958097927</p>
                </div>
              </div>
              <div className="bg-white p-4 sm:p-6 rounded-2xl border border-gray-100 shadow-sm flex items-center gap-3 sm:gap-4 hover:border-primary/30 transition-colors col-span-full">
                <div className="bg-orange-50 p-3 rounded-xl text-orange-600 flex-shrink-0"><Mail size={20} /></div>
                <div className="min-w-0">
                  <p className="text-xs text-gray-400 font-bold lowercase">email</p>
                  <p className="font-bold text-gray-800 text-sm sm:text-base break-all sm:break-normal">hello@manthanarchitects.com</p>
                </div>
              </div>
            </div>
          </div>
