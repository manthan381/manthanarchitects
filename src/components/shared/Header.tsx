...
const serviceLinks = [
  ...
  { name: "Build", href: "/projects?category=Office" },
...
function RollingTextLink({
  ...
  return (
    <Link
      href={href}
      onClick={onClick}
      className={`group relative transition-all duration-500 text-lg drop-shadow-md whitespace-nowrap lowercase flex flex-col items-center justify-center h-8 ${
        scrolled ? "text-[#1c2a22]" : "text-white"
      }`}
    >
  ...
  return (
    ...
    >
      <motion.div
        ...
        className="max-w-[1600px] w-full mx-auto pl-6 pr-10 sm:pl-10 sm:pr-16 lg:pl-14 lg:pr-24 py-[6px] flex items-center justify-between"
      >
        <div className="flex items-center">
          <Link href="/" className="group flex items-center gap-0 whitespace-nowrap">
            ...
            />
            <span
              className={`text-[19px] sm:text-2xl md:text-3xl font-bold tracking-wide drop-shadow-md lowercase -ml-10 transition-colors duration-500 ${
                isScrolled ? "text-[#1c2a22]" : "text-white"
        ...
        <div className="flex items-center gap-8">
          <nav className="hidden md:flex items-center space-x-8">
            ...
            <div className="group relative">
              <Link
                href="/services"
                className={`relative transition-all duration-500 text-lg drop-shadow-md whitespace-nowrap lowercase flex items-center gap-1 h-8 ${
                  isScrolled ? "text-[#1c2a22]" : "text-white"
                } hover:text-[#eb5e22]`}
              >
                <span>services</span>
